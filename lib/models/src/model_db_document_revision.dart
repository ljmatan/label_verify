...
class LvModelDocumentRevision {
  ...
  LvModelDocumentRevision({
    ...
    required this.successConfigurationIds,
    required this.errorConfigurationIds,
  });
  ...
  ///
  List<int> successConfigurationIds, errorConfigurationIds;
  ...
  factory LvModelDocumentRevision.fromJson(Map json) {
    return LvModelDocumentRevision(
      ...
      successConfigurationIds: List<int>.from(
        dart_convert.jsonDecode(
          json['successConfigurationIds'],
        ),
      ),
      errorConfigurationIds: List<int>.from(
        dart_convert.jsonDecode(
          json['errorConfigurationIds'],
        ),
      ),
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'successConfigurationIds': dart_convert.jsonEncode(
        successConfigurationIds,
      ),
      'errorConfigurationIds': dart_convert.jsonEncode(
