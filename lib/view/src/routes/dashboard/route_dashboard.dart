                        ...
                        Row(
                          children: [
                            ...
                            for (final action in <({
                              ...
                              if (LvDataDocuments.instance.collection.isEmpty)
                                (
                                  label: 'IMPORT USER DATA',
                                  tooltip: 'Upload data generated by the software with the "EXPORT" button.',
                                  icon: Icons.publish,
                                  onTap: () async {
                                    // await LvServiceFiles.instance.dataImport();
                                    _onDocumentUpdates();
                                  },
                                ),
                              if (LvDataDocuments.instance.collection.isNotEmpty)
                                (
                                  ...
                                  tooltip: 'Export recorded software data for later "IMPORT" action or review.',
                                  icon: Icons.save_alt,
                                  onTap: () async {
                                    // await LvServiceFiles.instance.dataExport();
                                  },
                                ),
                              (
                                label: 'NEW DOCUMENT',
                              ...
                              (
                                ...
                                tooltip: 'Specify and sort document result list according to set conditions.',
                                icon: Icons.settings,
                                onTap: snapshot.data?.isNotEmpty != true ? null : () async {},
                              ),
                            }.indexed)
                              Padding(
